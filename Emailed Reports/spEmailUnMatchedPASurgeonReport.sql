...
@body = @body,
@body_format ='HTML',
@recipients = 'Deborah.Reinagel@md-management.net;Tatjana.rosic@md-management.net;Kim.Anderson@md-management.net;Roshan.Shah@precisionassist.us;Matthew.Nartz@md-management.net', 
@subject = @subjectline;
