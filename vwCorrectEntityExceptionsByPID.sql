...
SELECT c.PID, 
	...
	CASE
		...
		WHEN c.[1st Insurance Category] IN ('Lein Case', 'Letter of Protection', 'Private Insurance', 'Aetna') AND SL1.Proentity IS NOT NULL THEN Sl1.Proentity -- Ticket #2186 Added Aetna as an Insurance category
