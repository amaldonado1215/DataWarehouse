...
ticket #12 /DR
nsert into PASurgeonLookup (surgeon, entity, startdate, enddate, region, surgeonownd, IOMSurgeonName,SurgeonNo,CoAbbr,sos_date,mngfee,billingfee, firstdos,firstcollection)
	values ('George Tipton, M.D.', 'NPPA Services', '2018-01-09','2020-12-31','PA - Austin', 'No','George Tipton, M.D.', 40074,'NPP','2015-07-23',.35,.08,'2018-01-09',' ')
