alter view vwIOMEntityAgingNewInsurance as 
...
select 
	...
	IIF ( -datediff(day, getdate(),CDH.claim_date) > 90,PIC.ins_charged - PIC.ins_writte_off -  isnull((select sum(ID.Payment_Collected) from Insurance_Deposits_3300 as ID where ID.Claim_id=PIC.claim_ID),0) ,  0 ) AS [90+Days],
